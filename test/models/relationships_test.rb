...
class RelationshipsTest < ActionView::TestCase
  ...
  test "_build_url" do
    ...
    assert_equal url, "http://cdrhsearch.unl.edu:3030/sparql?query=PREFIX%20oscys:%20%3Chttp://cdrhsites.unl.edu/data/projects/oscys/rdf/oscys.objectproperties.owl%23%3E%20%0A%20PREFIX%20osrdf:%20%3Chttp://cdrhsites.unl.edu/data/projects/oscys/rdf/oscys.relationships%23%3E%0A%20PREFIX%20rdfs:%20%3Chttp://www.w3.org/2000/01/rdf-schema%23%3E%20SELECT%20*%20FROM%20%3Chttp://cdrhsites.unl.edu/data/projects/oscys/rdf/oscys.relationships.ttl%3E%20WHERE%20%7B%20?s%20?p%20?o%20%7D%20&format=json"
  end
